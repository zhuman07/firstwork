...
function ale_enqueue_styles() {
	...
	// add general css file
		wp_register_style( 'wp_header_css', THEME_URL . '/css/header.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'wp_main_css', THEME_URL . '/css/main.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'wp_fonts_css', THEME_URL . '/css/fonts.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'wp_popup_css', THEME_URL . '/css/popup.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'wp_magnific_css', THEME_URL . '/libs/magnific-popup/dist/magnific-popup.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'wp_owlcarusel_css', THEME_URL . '/libs/owl.carousel/dist/assets/owl.carousel.min.css', array(), ALETHEME_THEME_VERSION, 'all');

    wp_enqueue_style('wp_header_css');
    wp_enqueue_style('wp_main_css');
    wp_enqueue_style('wp_fonts_css');
    wp_enqueue_style('wp_popup_css');
    wp_enqueue_style('wp_magnific_css');
    wp_enqueue_style('wp_owlcarusel_css');
}
...
function ale_enqueue_scripts() {
		...
		wp_register_script( 'html5-shim', THEME_URL . '/libs/html5shiv/html5shiv.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
		// add modernizr
		wp_register_script( 'wp_modernizr', THEME_URL . '/libs/modernizr/modernizr.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );

    wp_register_script( 'wp_respond', THEME_URL . '/libs/respond/respond.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'wp_superfish', THEME_URL . '/libs/superfish/dist/js/superfish.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'wp_magnific', THEME_URL . '/libs/magnific-popup/dist/jquery.magnific-popup.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'wp_carousel', THEME_URL . '/libs/owl.carousel/dist/owl.carousel.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'wp_scroll2id', THEME_URL . '/libs/scroll2id/PageScroll2id.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'wp_validatejs', THEME_URL . '/libs/jqBootstrapValidation/jqBootstrapValidation.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'wp_common', THEME_URL . '/js/common.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );

		wp_enqueue_script( 'html5-shim' );
		wp_enqueue_script( 'wp_modernizr' );
		wp_enqueue_script( 'wp_respond' );
    wp_enqueue_script( 'wp_common' );
    wp_enqueue_script( 'wp_superfish' );
    wp_enqueue_script( 'wp_magnific' );
    wp_enqueue_script( 'wp_carousel' );
    wp_enqueue_script( 'wp_scroll2id' );
